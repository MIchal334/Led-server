...
ChangeMode::ChangeMode(String optionName, int changeModeServerId, const std::function<std::map<int, uint32_t> (int,int,int,int)>& function)
...
std::function<std::map<int, uint32_t>(int,int,int,int)> ChangeMode::get_function()
{
